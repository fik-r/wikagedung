...
export default async function Index() {
    ...
    const [dataMenuHeader, dataHomepage, dataContact, dataContent, dataProyekBerjalan, dataProyekSelesai, dataKategori] =
        await Promise.all([
            ...
            getMenuContentByAlias("lini-bisnis/konstruksi-off-site-modular/lingkup-usaha"),
            getMenuContentByAlias("lini-bisnis/mdlr/proyek-berjalan"),
            getMenuContentByAlias("lini-bisnis/mdlr/proyek-sebelumnya"),
            getKategoriProyek()
        ])
    ...
    const content = () => {
        return (
            <LiniBisnis 
            route={"/lini-bisnis/konstruksi-off-site-modular/"}
