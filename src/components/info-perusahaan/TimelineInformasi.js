                ...
                <div className="flex flex-col z-10">
                    ...
                    <div className={cn("flex flex-row gap-x-[2.5rem] mt-[2.313rem] z-10", contentOpacity == 1 ? "fade-in" : "hidden")}>
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="w-text-body-2 text-white leading-[1.175rem]">{language == ENGLISH ? timelineItems[activeIndex].description_en : timelineItems[activeIndex].description}</div>
                        </div>
                    </div>
                </div>
