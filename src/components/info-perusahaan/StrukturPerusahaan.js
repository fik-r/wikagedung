...
const StrukturPerusahaan = ({ dataGroupPerusahaan, dataOrgPerusahaan }) => {
    ...
    return (
        <div className={cn("flex flex-col w-full", isMobile ? "px-[1rem] gap-y-3" : "gap-y-3")}>
            ...
            <div className="whitespace-pre-line" dangerouslySetInnerHTML={{ __html: language == ENGLISH ? dataGroupPerusahaan.content_data_en : dataGroupPerusahaan.content_data }}></div>
            ...
            <div className="whitespace-pre-line" dangerouslySetInnerHTML={{ __html: language == ENGLISH ? dataOrgPerusahaan.content_data_en : dataOrgPerusahaan.content_data }}></div>
        </div>
    )
}
