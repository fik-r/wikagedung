...
const BudayaPerusahaan = ({ dataVisiMisi, dataNilaiPerusahaan }) => {
    ...
    return (
        <div className={cn("flex flex-col w-full", isMobile ? "px-[1rem] gap-y-3" : "gap-y-3")}>
            ...
            <div className="whitespace-pre-line" dangerouslySetInnerHTML={{ __html: language == ENGLISH ? dataVisiMisi.content_data_en : dataVisiMisi.content_data }}></div>
            ...
            <div className="whitespace-pre-line" dangerouslySetInnerHTML={{ __html: language == ENGLISH ? dataNilaiPerusahaan.content_data_en : dataNilaiPerusahaan.content_data }}></div>
        </div>
    )
}
